...
(define (eval expr env)
  (cond
    ...
    ;; for ApplyF
    [ (equal? (car expr) 'apply) (eval (findMatch (car (second expr)) env) (RenewEnv (second (second expr)) (FuncParams (car (second expr)) env) (cons (findMatchF (car (second expr)) env) env))  )]
